...
fun HistoryScreenPreview() {
    val dataSource = NumbersDataSource(
        allPastNumbers = mutableListOf(
            Numbers(a = "8342234", b = "324423", c = "45456").apply { calculateResult() },
            Numbers(a = "4", b = "40", c = "400").apply { calculateResult() },
            Numbers(a = "42", b = "440", c = "5").apply { calculateResult() },
            Numbers(a = "3", b = "10", c = "78").apply { calculateResult() },
            Numbers(a = "5", b = "135", c = "7").apply { calculateResult() }
        ),
